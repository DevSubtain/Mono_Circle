...
public class CameraScaler : MonoBehaviour
{
    ...
    [SerializeField] private float w_amount = 33.5f; //Minimum units horizontally
    [SerializeField] private float h_amount = 20f; //Minimum units vertically
    ...
    void Update()
    {
        if (Screen.width != current_w || Screen.height != current_h || alwaysUpdate)
        {
            SetRes();
        }
    }
